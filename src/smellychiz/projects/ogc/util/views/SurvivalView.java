...
import smellychiz.projects.ogc.util.views.renderers.SurvivalRenderer;
import android.content.Context;
import android.graphics.PointF;
import android.view.MotionEvent;

public class SurvivalView extends GameView {
	public SurvivalRenderer c;

	public SurvivalView(Context context, int width, int height, Start a) {
	...
	public void initRend(Context context) {
		c = new SurvivalRenderer(context, parent.getName(), parent,
				parent.getFolder());
	}
